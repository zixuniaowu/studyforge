...
📖 **深入学习**：→ 本书 [2.10 Claude vs GPT 实测对比]
...
📖 **深入学习**：→ 本书 [2.3 MCP：AI 的"万能接口"] 和 [序章：大佬经验分享]
...
| 想了解... | 跳转到 |
|----------|--------|
| 模型怎么选？ | → 第2章第10节 [AI 模型对比与选型] |
| 什么是 MCP？ | → 第2章第3节 [MCP：AI 的万能接口] |
| 提示词技巧？ | → 第1章 [提示词工程进阶] |
| RAG 怎么优化？ | → 第3章第3节 [RAG 优化技巧] |
...
| 知りたいこと | ジャンプ先 |
|-------------|----------|
| モデル選び方 | → 第2章第10節 [AIモデル比較] |
| MCPとは？ | → 第2章第3節 [MCP] |
| プロンプト技術 | → 第1章 [プロンプトエンジニアリング] |
| RAG最適化 | → 第3章第3節 [RAG最適化] |
            `
          }
        },
        {
...
「AIとの対話術」をマスターしましょう！
        ...
        {
          id: 'ch1-structure',
          title: { zh: '1.1 提示词的核心结构', ja: '1.1 プロンプトのコア構造' },
          content: {
            zh: `
一个好的提示词通常包含这些要素：
...
4. **出力形式を明確に** —— やり取りを減らす
        ...
        {
          id: 'ch1-patterns',
          title: { zh: '1.2 常用提示词模式', ja: '1.2 よく使うプロンプトパターン' },
          content: {
            zh: `
...
5. **反復改善** —— AIに自己改善させる
        ...
        {
          id: 'ch1-advanced',
          title: { zh: '1.3 实战案例与高级技巧', ja: '1.3 実践例と上級テクニック' },
          content: {
            zh: `
## 真实场景：提示词实战
...
4. **テンプレート再利用** —— 自分のプロンプトライブラリを蓄積
        ...
        {
          id: 'ch1-summary',
          title: { zh: '1.4 本章小结', ja: '1.4 この章のまとめ' },
          content: {
            zh: `
## 提示词工程核心要点
...
AI Agentの世界に入りましょう！
        ...
        {
          id: 'ch2-how-it-works',
          title: { zh: '2.1 Agent 的工作原理', ja: '2.1 Agentの仕組み' },
          content: {
            zh: `
...
5. **ReAct パターン** —— 思考-行動-観察のループ
        ...
        {
          id: 'ch2-tools',
          title: { zh: '2.2 实用 Agent 工具', ja: '2.2 実用的なAgentツール' },
          content: {
            zh: `
...
4. **ニーズに応じて選択** —— ツールごとに異なる強み
        ...
        {
          id: 'ch2-mcp',
          title: { zh: '2.3 MCP：AI 的"万能接口"', ja: '2.3 MCP：AIの「万能インターフェース」' },
          content: {
            zh: `
## 什么是 MCP？
...
6. **Spec-Driven** —— 設計先行、一発で通す
        ...
        {
          id: 'ch2-claude-code-commands',
          title: { zh: '2.4 Claude Code 命令详解', ja: '2.4 Claude Code コマンド詳解' },
          content: {
            zh: `
## Claude Code 命令大全
...
5. **実用テクニック** —— コマンドを組み合わせて効率的なワークフローを実現
        ...
        {
          id: 'ch2-agent-skills',
          title: { zh: '2.5 Agent Skills 详解', ja: '2.5 Agent Skills 詳解' },
          content: {
            zh: `
...
5. **チーム共有** —— プロジェクトレベルSkillsでチーム標準化を実現
        ...
        {
          id: 'ch2-subagents',
          title: { zh: '2.6 Sub-agents 多 Agent 协作', ja: '2.6 Sub-agents マルチAgent協力' },
          content: {
            zh: `
## Sub-agents：专家团队协作模式
...
4. **Hooks自動化** —— イベント駆動のワークフロー自動化
        ...
        {
          id: 'ch2-opensource',
          title: { zh: '2.7 Claude Code 开源生态', ja: '2.7 Claude Code オープンソースエコシステム' },
          content: {
            zh: `
## Claude Code 开源生态
...
4. **awesome-*シリーズ** —— コミュニティ厳選リソース集
        ...
        {
          id: 'ch2-gemini-cli',
          title: { zh: '2.8 Gemini CLI 使用指南', ja: '2.8 Gemini CLI 使用ガイド' },
          content: {
            zh: `
...
6. **パイプ操作** —— 他のCLIツールとシームレス連携
        ...
        {
          id: 'ch2-openai-codex',
          title: { zh: '2.9 OpenAI Codex 使用指南', ja: '2.9 OpenAI Codex 使用ガイド' },
          content: {
            zh: `
...
6. **協同使用** —— Claude + Codexの組み合わせで各自の強みを発揮
        ...
        {
          id: 'ch2-models',
          title: { zh: '2.10 AI 模型对比与选型', ja: '2.10 AIモデル比較と選定' },
          content: {
            zh: `
## 2025 年主流 AI 编程工具对比
...
4. **ニーズに応じて選択** —— 単一ツールを盲信しない
        ...
        {
          id: 'ch2-summary',
          title: { zh: '2.11 本章小结', ja: '2.11 この章のまとめ' },
          content: {
            zh: `
## AI Agent 核心概念回顾
...
AIを「時代に追いつかせる」この技術を深く理解しましょう！
        ...
        {
          id: 'ch3-how-it-works',
          title: { zh: '3.1 RAG 的工作原理', ja: '3.1 RAGの仕組み' },
          content: {
            zh: `
让我们看看 RAG 是如何工作的。
...
5. **プロンプト組み合わせ** —— 検索結果と質問をLLMに渡す
        ...
        {
          id: 'ch3-applications',
          title: { zh: '3.2 RAG 的应用场景', ja: '3.2 RAGの応用シーン' },
          content: {
            zh: `
RAG 在很多场景中都有广泛应用。
...
4. **共通点** —— プライベート/専門知識に基づく回答
        ...
        {
          id: 'ch3-optimization',
          title: { zh: '3.3 RAG 优化技巧', ja: '3.3 RAG 最適化テクニック' },
          content: {
            zh: `
## 让 RAG 更精准的关键技巧
...
4. **Reranker** —— 2段階検索で精度向上
        ...
        {
          id: 'ch3-summary',
          title: { zh: '3.4 本章小结', ja: '3.4 この章のまとめ' },
          content: {
            zh: `
## RAG 核心概念回顾
...
| 4.5 | LoRA実践 | 低コストチューニングのベストプラクティス |
        ...
        {
          id: 'ch4-transformer',
          title: { zh: '4.1 Transformer 架构详解', ja: '4.1 Transformerアーキテクチャ詳解' },
          content: {
            zh: `
## Transformer：改变世界的架构
...
5. **現代のトレンド** —— GPT/Claude/Llamaは全てDecoder-Only
        ...
        {
          id: 'ch4-attention',
          title: { zh: '4.2 注意力机制深入理解', ja: '4.2 アテンション機構の深い理解' },
          content: {
            zh: `
...
└─────────────────────────────────────────────────────────────────────────┘
  ...
  score(猫→猫) = Q₁ · K₁ = [1.2, 0.8] · [0.9, 1.1] = 1.08 + 0.88 = 1.96
  score(猫→吃) = Q₁ · K₂ = [1.2, 0.8] · [1.0, 0.6] = 1.20 + 0.48 = 1.68
  score(猫→鱼) = Q₁ · K₃ = [1.2, 0.8] · [0.4, 1.3] = 0.48 + 1.04 = 1.52
...
6. **Top-k/Top-p** —— サンプリング範囲を制限、品質と多様性のバランス
        ...
        {
          id: 'ch4-finetune-intro',
          title: { zh: '4.3 大模型微调入门', ja: '4.3 大規模モデルファインチューニング入門' },
          content: {
            zh: `
## 什么是微调（Fine-tuning）？
...
4. **ツール選択** —— LLaMA-Factoryは初心者向け、PEFTはより柔軟
        ...
        {
          id: 'ch4-lora-practice',
          title: { zh: '4.4 LoRA 微调实战', ja: '4.4 LoRA ファインチューニング実践' },
          content: {
            zh: `
## LoRA 微调实战指南
