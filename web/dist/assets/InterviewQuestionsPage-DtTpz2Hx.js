import{c as g,g as p,u as P,r as u,j as e,C as h,E as f,n as C,W as x,p as j}from"./index-C6rNVC4f.js";import{H as y}from"./house-CDyYd-Q8.js";import{C as A}from"./cloud-BoIDgXue.js";import{S as N}from"./star-BVE51leX.js";import{C as L}from"./chevron-down-CBg-bASN.js";import{C as R}from"./circle-check-BLJwdBtm.js";const B=[["path",{d:"M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719",key:"1sd12s"}]],S=g("message-circle",B),l={"cloud-general":{name:{zh:"云计算基础",ja:"クラウド基礎"},description:{zh:"云计算核心概念和架构问题",ja:"クラウドコンピューティングの基本概念とアーキテクチャ"},icon:A,gradient:"from-cyan-500 to-blue-600",questions:[{id:"cg-1",question:{zh:"什么是云计算？请解释 IaaS、PaaS、SaaS 的区别。",ja:"クラウドコンピューティングとは何ですか？IaaS、PaaS、SaaSの違いを説明してください。"},answer:{zh:`**云计算**是通过互联网提供计算资源（服务器、存储、数据库、网络等）的服务模式。
